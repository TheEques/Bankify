...
if (isset($_POST['submit1'])) {
  ...
  if (mysqli_num_rows($result) === 1) {
      ...
      // Fetch user's transaction data from transaction_history table
      ...
      if ($transaction_result) {
          ...
          // Store calculated values into total_transactions table
          $insert_query = "INSERT INTO total_transactions (user_email, total_deposits, total_withdrawals, credit_history) " .
                          "VALUES ('{$email}', {$total_deposits}, {$total_withdrawals}, {$credit_history}) " .
                          "ON DUPLICATE KEY UPDATE total_deposits={$total_deposits}, total_withdrawals={$total_withdrawals}, credit_history={$credit_history}";
          ...
          $msg ="<div class='alert alert-danger'>Error fetching transaction data.</div>";
      }
  } else {
