    ...
    if ($result) {
        if (mysqli_num_rows($result) === 1) {
            ...
            if ($row['password'] === $password) {
                ...
                // Redirect to the Flask route for script execution with the user's email as a parameter
                header("Location: http://127.0.0.1:5000/execute_script?email=" . urlencode($row['email']));
